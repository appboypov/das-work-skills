...
description: Write clear instructions for agents. Use when creating skills or project instruction documents.
---

Read [workflow](../workflow/SKILL.md) before applying this skill.


Reference for writing any document an agent consumes: a skill, a project instruction file, or a linked reference. Structure the instructions so the agent follows a predictable process while adapting its output to the actual task.
