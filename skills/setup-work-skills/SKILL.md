...
6. Verify skill discovery, runtime version, schema resolution, Linear access, configured intent and brain folders, and the selected planning root. Report their actual locations and any missing capability.
