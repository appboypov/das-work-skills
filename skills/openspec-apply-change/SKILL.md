...
4. Confirm the explicit implementation approval covers the pending work. Read project conventions and current code in each participating repository. If this invocation targets one issue or slice, restrict execution to its corresponding tasks and actual prerequisites.
